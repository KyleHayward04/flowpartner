          ...
          <div class="dashboard">
            <aside class="dashboard-sidebar">
              ...
              <ul class="sidebar-nav">
                ...
                <li><a href="#/business/subscription">Subscription</a></li>
              </ul>
            </aside>
...
export async function renderSubscription() {
  ...
  // Mock current subscription data (will be replaced with backend data later)
  const currentPlan = {
    name: 'Trial',
    price: 0,
    status: 'active',
  ...
  if (state.user.role === 'BUSINESS_OWNER') {
    dashboardTitle = 'Business Dashboard';
    dashboardLink = '#/business/dashboard';
    sidebarNav = `
      <li><a href="#/business/dashboard">My Jobs</a></li>
      <li><a href="#/business/create-job">Create Job</a></li>
      <li><a href="#/business/profile">Profile</a></li>
      <li><a href="#/business/subscription" class="active">Subscription</a></li>
    `;
  } else if (state.user.role === 'FREELANCER') {
    dashboardTitle = 'Freelancer Dashboard';
    dashboardLink = '#/freelancer/dashboard';
    sidebarNav = `
      <li><a href="#/freelancer/dashboard">My Work</a></li>
      <li><a href="#/freelancer/jobs">Browse Jobs</a></li>
      <li><a href="#/freelancer/profile">Profile</a></li>
      <li><a href="#/freelancer/subscription" class="active">Subscription</a></li>
    `;
  } else if (state.user.role === 'ADMIN') {
    dashboardTitle = 'Admin Dashboard';
    ...
    sidebarNav = `
      ...
      <li><a href="#/admin/subscription" class="active">Subscription</a></li>
    `;
  }
    ...
    <div class="view">
      <div class="container">
        <div class="dashboard">
          ...
          <div class="dashboard-content">
            <h1 class="mb-lg">Subscription</h1>
            
            <!-- Current Plan -->
            <div class="card mb-xl">
              <h2 class="mb-md">Current Plan</h2>
              <div style="background: var(--color-bg-elevated); padding: var(--space-lg); border-radius: var(--radius-lg); margin-bottom: var(--space-lg);">
                <div class="flex flex-between mb-md">
                  <div>
                    <h3 style="margin: 0;">${currentPlan.name}</h3>
                    <p class="text-muted" style="margin: var(--space-xs) 0 0;">
                      ${currentPlan.name === 'Trial' ? `${currentPlan.daysRemaining} days remaining` : 'Active subscription'}
                    </p>
                  </div>
              ...
              ${currentPlan.name === 'Trial' ? `
                <div style="background: var(--gradient-primary); padding: var(--space-lg); border-radius: var(--radius-lg); color: white;">
            ...
            <div class="pricing-grid" style="margin-bottom: var(--space-xl);">
              ...
              <div class="pricing-card pricing-card-free">
                ...
                <p class="pricing-description">Perfect for testing the waters</p>
                ...
                ${currentPlan.name === 'Trial' ? `
                  <button class="btn btn-secondary btn-block btn-lg pricing-cta" disabled>
                    Current Plan
                  </button>
                ` : `
                  <button class="btn btn-secondary btn-block btn-lg pricing-cta" onclick="alert('Trial period has ended. Please upgrade to a paid plan.')">
                    Trial Expired
                  </button>
                `}
              </div>
              ...
              <div class="pricing-card pricing-card-starter">
                ...
                <p class="pricing-description">Ideal for small businesses</p>
                
                <ul class="pricing-features">
                  <li><i data-lucide="check"></i> <strong>Unlimited jobs</strong></li>
                  <li><i data-lucide="check"></i> Priority support</li>
                  <li><i data-lucide="check"></i> Advanced messaging</li>
                  <li><i data-lucide="check"></i> AI-assisted matching</li>
                  <li><i data-lucide="check"></i> 3% platform fee</li>
                  <li><i data-lucide="check"></i> Project analytics</li>
                </ul>
                
                ${currentPlan.name === 'Starter' ? `
                  <button class="btn btn-primary btn-block btn-lg pricing-cta" disabled>
                    Current Plan
                  </button>
                ` : `
                  <button class="btn btn-primary btn-block btn-lg pricing-cta" onclick="alert('Subscription backend coming soon! This will upgrade you to Starter plan.')">
                    ${currentPlan.price > 25 ? 'Downgrade' : 'Upgrade'} to Starter
                  </button>
                `}
              </div>
              ...
              <div class="pricing-card pricing-card-growth">
                ...
                <p class="pricing-period">per month</p>
                <p class="pricing-description">For growing teams</p>
                ...
                <ul class="pricing-features">
                  ...
                  <li><i data-lucide="check"></i> Quarterly reviews</li>
                  <li><i data-lucide="check"></i> Priority matching</li>
                </ul>
                
                ${currentPlan.name === 'Growth' ? `
                  <button class="btn btn-accent btn-block btn-lg pricing-cta" disabled>
                    Current Plan
                  </button>
                ` : `
                  <button class="btn btn-accent btn-block btn-lg pricing-cta" onclick="alert('Subscription backend coming soon! This will upgrade you to Growth plan.')">
                    ${currentPlan.price > 50 ? 'Downgrade' : 'Upgrade'} to Growth
                  </button>
                `}
              </div>
            </div>
            ...
            <div class="card">
              <h2 class="mb-lg">Subscription Settings</h2>
              
              <div class="form-group">
                <label class="form-label">Payment Method</label>
                <div style="background: var(--color-bg-elevated); padding: var(--space-md); border-radius: var(--radius-md); margin-bottom: var(--space-md);">
              ...
              <div class="form-group">
                ...
                <div class="flex gap-sm">
                  <button class="btn btn-secondary" onclick="alert('Backend implementation coming soon!')">
                  ...
                  ${currentPlan.name !== 'Trial' ? `
                    <button class="btn btn-error" onclick="if(confirm('Are you sure you want to cancel your subscription?')) alert('Backend implementation coming soon!')">
                      Cancel Subscription
                    </button>
                  ` : ''}
                </div>
